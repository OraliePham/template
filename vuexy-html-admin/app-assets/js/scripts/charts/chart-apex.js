...
$(document).ready(function () {
 ...
 // Queue
  ...
  var mixedChartOptions = {
    ...
    // colors: ['#3A5794', '#A5C351', '#E14A84'],
    series: [{
      name: 'Waiting calls in queue',
      type: 'column',
      data: [23, 11, 22, 27, 13, 22, 37, 21, 44, 22, 30]
    }, {
      name: 'User online in queue',
      type: 'area',
      data: [44, 55, 41, 67, 22, 43, 21, 41, 56, 27, 43]
    }],
    fill: {
  ...
  var mixedChart = new ApexCharts(
    document.querySelector("#queue-performance"),
    mixedChartOptions
  );
  mixedChart.render();
 ...
 // Peak time
  ...
  var mixedChartOptions = {
    ...
    labels: ['7-83', '8-9', '9-10', '10-11', '11-12', '12-13', '13-14', '14-15', '15-16', '16-17', '17-18'],
    markers: {
      size: 0
    },
    legend: {
  ...
  var mixedChart = new ApexCharts(
    document.querySelector("#peak-time"),
    mixedChartOptions
  );
  mixedChart.render();
